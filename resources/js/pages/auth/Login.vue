        ...
        <div class="relative grid min-h-screen lg:grid-cols-2">
            ...
            <div class="hidden flex-col justify-between border-r border-slate-800/50 bg-[#060a14]/90 p-12 lg:flex">
                ...
                <div class="flex items-center gap-2.5">
                    <span
                        class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-500/20 text-indigo-300">
                ...
                <div class="space-y-5">
                    ...
                    <p class="max-w-xs text-sm leading-relaxed text-slate-400">
                        Join thousands of teams scaling their operations on the most reliable performance-driven SaaS
                        platform. Experience high-speed data delivery and seamless user integration.
                    </p>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <div
                        class="flex items-center gap-2 rounded-full border border-slate-700/60 bg-slate-800/40 px-4 py-2 text-xs font-medium tracking-wide text-slate-300">
            ...
            <div class="flex items-center justify-center px-6 py-12">
                <div class="w-full max-w-sm space-y-6">
                    ...
                    <!-- Status alert -->
                    <div v-if="status"
                        class="rounded-lg border border-emerald-700 bg-emerald-950/70 px-3 py-2 text-center text-sm text-emerald-200">
                        {{ status }}
                    </div>

                    <!-- Form card -->
                    <div
                        class="rounded-2xl border border-slate-700/50 bg-[#0d1525] p-8 shadow-[0_32px_64px_rgba(0,0,0,0.6)]">
                        <div class="mb-7">
                            <h1 class="font-[Manrope] text-2xl font-bold text-white">Welcome back</h1>
                        ...
                        <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
                            ...
                            <div class="flex flex-col gap-1.5">
                                <Label for="email"
                                    class="font-[JetBrains_Mono] text-[10px] uppercase tracking-[0.1em] text-slate-400">Email
                                    address</Label>
                            ...
                            <div class="flex flex-col gap-1.5">
                                <div class="flex items-center justify-between">
                                    <Label for="password"
                                        class="font-[JetBrains_Mono] text-[10px] uppercase tracking-[0.1em] text-slate-400">Password</Label>
                                    <Link v-if="canResetPassword" :href="request()"
                                        class="text-xs text-indigo-300 transition hover:text-indigo-200" tabindex="5">
                            ...
                            <!-- Register link -->
                            <div class="border-t border-slate-700/50 pt-4" v-if="canRegister">
                                <p class="text-center text-sm text-slate-400">
                                    Don't have an account yet?
                                    <Link :href="register()"
                                        class="ml-1 font-medium text-indigo-300 transition hover:text-indigo-200">
                                        Create an account
                                    </Link>
                                </p>
                            </div>
                            ...
                            <div class="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                                ...
                                <span class="font-[JetBrains_Mono] text-[10px] tracking-[0.1em] text-slate-500">OR
                                    CONTINUE WITH</span>
                                <span class="h-px bg-slate-700/60"></span>
                            </div>
                    ...
                    <div class="flex items-center justify-center gap-8 opacity-40">
                        <div class="flex flex-col items-center gap-1">
                            <span class="material-symbols-outlined text-lg text-indigo-300">speed</span>
                            <span
                                class="font-[JetBrains_Mono] text-[10px] uppercase tracking-widest text-slate-400">Speed</span>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <span class="material-symbols-outlined text-lg text-indigo-300">security</span>
                            <span
                                class="font-[JetBrains_Mono] text-[10px] uppercase tracking-widest text-slate-400">Secure</span>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <span class="material-symbols-outlined text-lg text-indigo-300">analytics</span>
                            <span
                                class="font-[JetBrains_Mono] text-[10px] uppercase tracking-widest text-slate-400">Analytics</span>
                        </div>
                    </div>
