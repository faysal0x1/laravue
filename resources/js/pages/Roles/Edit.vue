    ...
    <div class="mx-auto w-full max-w-5xl p-4">
        <div class="grid gap-4 lg:grid-cols-[1.1fr,2fr]">
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-card p-5 dark:border-sidebar-border">
                <h1 class="mb-5 text-lg font-semibold">Edit Role</h1>
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-card p-5 dark:border-sidebar-border">
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <button v-if="form.permissions.length > 0" type="button"
                        class="text-xs text-destructive hover:underline" @click="clearAllPermissions">
                        Clear all
                    </button>
                </div>
