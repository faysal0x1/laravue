...
const notifications = [
    { id: 1, title: 'New employee registered', time: '2m ago' },
    { id: 2, title: 'Monthly report is ready', time: '15m ago' },
];
</script>
                ...
                <div class="ml-auto flex items-center space-x-2">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger :as-child="true">
                            ...
                            >
                                <Bell class="size-5" />
                                <span class="absolute top-1.5 right-1.5 size-2 rounded-full bg-red-500" />
                            </Button>
                        </DropdownMenuTrigger>
